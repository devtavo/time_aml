var AppIndexIncidente = function() {
    ...
    var jQueryEvts = function() {
        ...
        $(document).on('click', '[name="btnEditarInc[]"]', function(e) {
            ...
            var id_envios = Number(tr.attr('data-id'));

            App.tabStorage('detalle_incidente', id_envios);
            modal_det_incidente(id_envios);
        });
    ...
    var modal_det_incidente = function(id_envios) {
        $.get(path_root + "/users/dashboard/edit.php", { id_envios: id_envios }, function(data) {
    ...
    var fs_incidente = function(pagina = 0) {
        ...
        data.class = 'DashboardController';
        data.method = 'index';
        ...
        $.ajax({
            ...
            data: data,
            success: function(response) {
                $.get(path_root + '/users/dashboard/vista.php', data, function(response) {
